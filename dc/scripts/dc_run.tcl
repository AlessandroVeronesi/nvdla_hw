...
# FIXME: RetimeRegister constraints
...
setVar FLATTEN_OUTPUT 1
if {[info exists FLATTEN_OUTPUT] && $FLATTEN_OUTPUT ==1 } {
    set power_cg_flatten true
    ungroup -all -flatten  
}
...
write -format verilog -hierarchy -out ${NET_DIR}/${MODULE}.v
...
redirect ${REPORT_DIR}/${MODULE}.area.report { report_area -hierarchy }
...
puts "${synMsgInfo} GENERATED NETLIST: ${NET_DIR}/${MODULE}.v"
