...
create_clock [get_ports nvdla_falcon_clk]  -period 4000  -waveform {0 2000}
...
#create_clock [get_ports nvdla_falcon_clk]  -period 10000  -waveform {0 5000}
#set_clock_transition -max -rise 0.1 [get_clocks nvdla_falcon_clk]
#set_clock_transition -max -fall 0.1 [get_clocks nvdla_falcon_clk]
#set_clock_transition -min -rise 0.1 [get_clocks nvdla_falcon_clk]
#set_clock_transition -min -fall 0.1 [get_clocks nvdla_falcon_clk]
