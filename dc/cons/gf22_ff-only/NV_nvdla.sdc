...
set_max_area 0
create_clock [get_ports dla_core_clk]  -period 4000  -waveform {0 2000}
...
set_false_path   -from [get_ports nvdla_pwrbus_ram_*]
set_false_path   -from [get_ports tmc2slcg_disable_clock_gating]
set_false_path   -from [get_ports global_clk_ovr_on]
set_false_path   -from [get_ports u_partition_o/nvdla_clk_ovr_on]
